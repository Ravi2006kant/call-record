...
class _CallLogScreenState extends State<CallLogScreen>
  ...
  /// Turns the native "status" code into something the tester can act on.
  String _statusText(String status) {
    switch (status) {
      case 'ok':
        return 'Recorded';
      case 'no_mic_permission':
        return 'No recording — microphone permission not granted';
      case 'not_started':
        return 'No recording — recorder never started';
      case 'file_missing':
        return 'No recording — file was never created';
      case 'silent_or_empty':
        return 'No recording — captured silence (mic likely blocked during calls on this phone, or speaker was off)';
      default:
